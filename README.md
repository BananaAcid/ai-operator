...
| v1.0.41 | **Navigation, Capabilities** <br> Added matching more reasoning blocks, fixed get-models to get all available models, code cleanup | [1.0.40...1.0.41](https://github.com/BananaAcid/ai-operator/compare/1.0.40...1.0.41) |