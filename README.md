...
| v1.0.41 | **Navigation, Capabilities** <br> Added matching more reasoning blocks, fixed get-models to now get all available models, added <kbd>esc</kbd> to cancel driver and model selection, added option to selectively disable prompt commands (internal MCP functions), code cleanup | [1.0.40...1.0.41](https://github.com/BananaAcid/ai-operator/compare/1.0.40...1.0.41) |