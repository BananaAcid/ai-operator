...
let settingsSaved: Settings = await readFile(rcFilePath, 'utf-8').then(JSON.parse).catch(_ => {}) as Settings;
...
let settings: Settings = {
    ...{//* default settings
        ...
        systemPrompt: `
            ...
            ### Helpers
            - getting an api, create a command by using curl and proccess the <CMD-OUTPUT> afterwards.
